//2010/11 p75
// =====================================================
// Savar (Dhaka) — SUHI Apr–Sep 2005–2006
// Landsat 5 Collection 2 Level 2
// UPDATED ROADMAP IMPLEMENTATION:
// - 2-year block (2005–2006), Apr–Sep
...
// -------------------------
var PERIOD_NAME = '2010_2011_AprSep';
var START_DATE  = '2010-01-01';
var END_DATE    = '2012-01-01';  // end-exclusive
var MONTH_START = 4;
var MONTH_END   = 7;           
...
// -------------------------
// 6) Scene-level flood filter helper (L5)
// -------------------------
function addWaterFracPerScene_L5(img) {
  // L5 SR bands: Green=SR_B2, Red=SR_B3, NIR=SR_B4, SWIR1=SR_B5
...
// -------------------------
var l5raw = ee.ImageCollection('LANDSAT/LT05/C02/T1_L2')
...
print('L5 scenes (raw):', l5raw.size());
print('L5 scenes retained (QC >= ' + SCENE_VALID_FRAC_MIN + ' validFrac):', l5.size());
print('Retained validFrac list:', l5.aggregate_array('validFrac'));

// Apply flood filter BEFORE compositing
l5 = l5.map(addWaterFracPerScene_L5)
       .filter(ee.Filter.lte('waterFrac', MAX_WATER_FRAC));

print('Scenes retained after flood filter:', l5.size());
print('Retained waterFrac list:', l5.aggregate_array('waterFrac'));


// -------------------------
// 8) Thermal composite: p75 LST (°C) — PRIMARY LST surface
// -------------------------
var lstCol = l5.select('LST_C');
