//2015/16 p75
// =====================================================
// Savar (Dhaka) — SUHI Apr–Sep 2015–2016
// Landsat 8 Collection 2 Level 2
// UPDATED ROADMAP IMPLEMENTATION:
// - 2-year block (2015–2016), Apr–Sep
...
// -------------------------
// 1) Period settings (2-year block) ✅ 2015/2016
// -------------------------
var PERIOD_NAME = '2015_2016_AprSep';
var START_DATE  = '2015-01-01';
var END_DATE    = '2017-01-01';  // end-exclusive
var MONTH_START = 4;
...
var MAX_WATER_FRAC = 0.30; // if too strict, use 0.30 (keep same across years)


// -------------------------
// 3) QA masking (cloud/shadow/saturation) — Landsat 8
// -------------------------
function maskL8C2(img) {
...
// -------------------------
// 4) LST (ST_B10) to Celsius — Landsat 8
// -------------------------
...
// -------------------------
// 6) Scene-level flood filter helper (L8)
// -------------------------
function addWaterFracPerScene_L8(img) {
  // L8 SR bands: Green=SR_B3, Red=SR_B4, NIR=SR_B5, SWIR1=SR_B6
...
print('L8 scenes retained (QC >= ' + SCENE_VALID_FRAC_MIN + ' validFrac):', l8.size());
print('Retained validFrac list:', l8.aggregate_array('validFrac'));

// Apply flood filter BEFORE compositing
l8 = l8.map(addWaterFracPerScene_L8)
       .filter(ee.Filter.lte('waterFrac', MAX_WATER_FRAC));

print('Scenes retained after flood filter:', l8.size());
print('Retained waterFrac list:', l8.aggregate_array('waterFrac'));


// -------------------------
// 8) Thermal composite: p75 LST (°C) — PRIMARY LST surface
// -------------------------
var lstCol = l8.select('LST_C');
...
// Use same QC-retained scenes for spectral too
var srCol = l8.map(addIndicesL8);
